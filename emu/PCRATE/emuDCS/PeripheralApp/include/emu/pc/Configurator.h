#ifndef _emu_pc_Configurator_h_
#define _emu_pc_Configurator_h_
...
namespace emu {
  namespace pc {
    ...
    public:
      ...
      /// constructor
      Configurator( xdaq::ApplicationStub *s );
    ...
    protected:
      ...
      // SOAP callbacks
      xoap::MessageReference onSetConfiguration( xoap::MessageReference message );
      ...
      void ConfigSelectorPage( xgi::Input *in, xgi::Output *out );
      void BusyPage( xgi::Input *in, xgi::Output *out );
      ...
      // Utilities for web pages
      void pageHeader( xgi::Input *in, xgi::Output *out, const emu::pc::AppNavigator& appNav );
      void pageFooter( xgi::Input *in, xgi::Output *out );
      void htmlHeader( xgi::Input *in, xgi::Output *out, const string& title, const int refreshPeriod = -1 );
      void htmlFooter( xgi::Input *in, xgi::Output *out );
      string configTimeStampHTML();
      bool hasCurrentConfigTimeStamp( xgi::Input *in );
      std::string disableInSlave();
      // Initializers
      void initializeParameters();
      void exportParameters();
      void bindWebInterface();
      void bindSOAPInterface();
      void DefineFirmwareFilenames();
      // Work flow
      void actionPerformed( xdata::Event& received );
      bool waitForSlavesToFinish();
      void stopSlaves();
      // Tasks
      void dummyTask();
      void SetCurrentCrate( const int cr );
      void ConfigureInit( int mode );
      ...
      xdata::String tStoreViewFile_;
      emu::pc::Configuration::Source_t selectedSource_;
      std::vector<std::string> selectedConfigIds_;
      emu::pc::Configuration configuration_;
      std::string webPageMessage_; // TODO: one for every page
      std::map<xdaq::ApplicationDescriptor*,VMEAccessor::Status_t> slavesStatus_;

    private:
      virtual bool vmeAccessInWorkLoop( toolbox::task::WorkLoop *wl );
