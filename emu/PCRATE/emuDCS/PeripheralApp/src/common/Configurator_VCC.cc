...
void emu::pc::Configurator::VCCHeader(xgi::Input * in, xgi::Output * out, std::string title, std::string heading ) 
...
void emu::pc::Configurator::ControllerUtils_Xfer(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
...
void emu::pc::Configurator::ControllerUtils(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
...
void emu::pc::Configurator::VMECC_UTIL_Menu_Buttons(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
...
void emu::pc::Configurator::VMECCGUI_GoTo_General(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
...
void emu::pc::Configurator::VMECCGUI_GoTo_Intermediate(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
...
void emu::pc::Configurator::VMECCGUI_GoTo_Expert(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
...
void emu::pc::Configurator::VMECC_UTIL_Crate_Selection(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
...
void emu::pc::Configurator::VCC_CRSEL_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
  int i;
  bool found;
...
void emu::pc::Configurator::VCC_PSWD_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
...
void emu::pc::Configurator::VCC_CMNTSK_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
  char ctemp[256];
...
void emu::pc::Configurator::VMECCGUI_VME_access(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
  static bool first = true;
...
void emu::pc::Configurator::VCC_VME_FILL(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
...
void emu::pc::Configurator::VCC_VME_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
...
void emu::pc::Configurator::VMECCGUI_firmware_utils(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
  static bool first = true;
  Crate *lccc;
  lccc = VCC_UTIL_curr_crate;
...
void emu::pc::Configurator::VCC_FRMUTIL_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
  char ctemp[256];
  char *cptemp;
...
void emu::pc::Configurator::VMECCGUI_cnfg_utils(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
  static bool first = true;
  Crate *lccc;
  lccc = VCC_UTIL_curr_crate;
...
void emu::pc::Configurator::VCC_CNFG_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
  char ctemp[256];
  CNFG_ptr rbk_cp;
...
void emu::pc::Configurator::VMECCGUI_MAC_utils(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
  static bool first = true;
  std::string ena_dis;
  Crate *lccc;
...
void emu::pc::Configurator::VCC_MAC_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
  char ctemp[256];
  CNFG_ptr rbk_cp;
...
void emu::pc::Configurator::VMECCGUI_FIFO_utils(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
  CNFG_ptr rbk_cp;
  static bool first = true;
  Crate *lccc;
...
void emu::pc::Configurator::VCC_FIFO_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
...
void emu::pc::Configurator::VMECCGUI_pkt_send(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
  static bool first = true;
  Crate *lccc;
  lccc = VCC_UTIL_curr_crate;
...
void emu::pc::Configurator::VCC_PKTSND_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
  unsigned int itemp;
  int i,nwrds;
...
void emu::pc::Configurator::VMECCGUI_pkt_rcv(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
  char ctemp[256];
  static bool first = true;
  Crate *lccc;
...
void emu::pc::Configurator::VCC_PKTRCV_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
  char ctemp[256];
  char ctemp2[256];
...
void emu::pc::Configurator::VMECCGUI_misc_utils(xgi::Input * in, xgi::Output * out ) throw (xgi::exception::Exception)
{
  CNFG_ptr rbk_cp;
  int msglvl;
  char ctemp[256];
...
void emu::pc::Configurator::VCC_MISC_DO(xgi::Input * in, xgi::Output * out )
    throw (xgi::exception::Exception)
{
  CNFG_ptr rbk_cp;
  char ctemp[256];
