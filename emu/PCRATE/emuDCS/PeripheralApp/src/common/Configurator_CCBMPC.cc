...
// CCB utilities
/////////////////////////////////////////////////////////
void emu::pc::Configurator::CCBStatus(xgi::Input * in, xgi::Output * out ) 
...
//
void emu::pc::Configurator::CCBUtils(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
...
//
  void emu::pc::Configurator::CCBLoadFirmware(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
    //
    int debugMode(0);
    int jch(0);
    int verify(1);
    std::cout << emu::utils::getDateTime() << " Programming CCB using " << CCBFirmware_ << std::endl;
    int status = thisCCB->svfLoad(jch,CCBFirmware_.c_str(),debugMode, verify);
    if (status >= 0){
      std::cout << emu::utils::getDateTime() << " Programming finished with " << status << " Verify Errors occured" << std::endl;
    }
    else{
      std::cout << emu::utils::getDateTime() << " Fatal Error. Exiting with " <<  status << std::endl;
    }
    //
    //    thisCCB->hardReset();
    //
...
void emu::pc::Configurator::CCBReadFirmware(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  std::string mcsfile="/tmp/CCB_"+ ThisCrateID_ + ".mcs";
  std::string jtagfile=XMLDIR+"/ccb.vrf";
  std::cout << emu::utils::getDateTime() << " Reading CCB firmware; saving as " << mcsfile << std::endl;
  ...
  //
  void emu::pc::Configurator::CCBConfig(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
    thisCCB->configure();
    this->CCBUtils(in,out);
  ...
  void emu::pc::Configurator::PrepareForTriggering(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
    //// could we just do:
  ...
  void emu::pc::Configurator::CCBSignals(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
     cgicc::Cgicc cgi(in);
...
// MPC methods
//////////////////////////////////////////////////
void emu::pc::Configurator::MPCStatus(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  char Name[100];
...
//
void emu::pc::Configurator::MPCUtils(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  char Name[100];
  char buf[200];
...
//
void emu::pc::Configurator::MPCLoadFirmware(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  int debugMode(0);
  int jch(0);
  int verify(1);
  std::cout << emu::utils::getDateTime() << " Programming MPC using " << MPCFirmware_ << std::endl;
...
void emu::pc::Configurator::MPCReadFirmware(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  std::string mcsfile="/tmp/MPC_"+ ThisCrateID_ + ".mcs";
  std::string jtagfile=XMLDIR+"/mpc.vrf";
  std::cout << emu::utils::getDateTime() << " Reading MPC firmware; saving as " << mcsfile << std::endl;
  ...
  void emu::pc::Configurator::MPCConfig(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
    thisMPC->configure();
    this->MPCUtils(in,out);
  ...
  //
  void emu::pc::Configurator::ReadCCBRegister(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
    //
    cgicc::Cgicc cgi(in);
  ...
  //
  void emu::pc::Configurator::WriteCCBRegister(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
    //
    cgicc::Cgicc cgi(in);
  ...
  void emu::pc::Configurator::ReadTTCRegister(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
  ...
  //
  void emu::pc::Configurator::HardReset(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
    //
    cgicc::Cgicc cgi(in);
  ...
  //
  void emu::pc::Configurator::ReadMPCRegister(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
    //
    cgicc::Cgicc cgi(in);
  ...
  //
  void emu::pc::Configurator::WriteMPCRegister(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
    //
    cgicc::Cgicc cgi(in);
...
//
void emu::pc::Configurator::MPCMask(xgi::Input * in, xgi::Output * out )
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
// CCB tests
//////////////////////////////////////////////////////////////
void emu::pc::Configurator::CCBTests(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::CCBTestAll(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
  void emu::pc::Configurator::CCBSetTestLoops(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
  ...
  //
  void emu::pc::Configurator::LogCCBTestsOutput(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception)
  {
    //
