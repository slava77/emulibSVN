...
// DMB tests
//////////////////////////////////////////////////////////////
void emu::pc::Configurator::DMBTests(xgi::Input * in, xgi::Output * out ) 
...
//
void emu::pc::Configurator::DMBTestAll(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBTest3(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBTest4(xgi::Input * in, xgi::Output * out ) 
    throw (xgi::exception::Exception){
    //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBTest5(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBTest6(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBTest8(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBTest9(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
    //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBTest10(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
//
void emu::pc::Configurator::RTRGlow(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
//
void emu::pc::Configurator::RTRGhigh(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBTest11(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
// DMB utilities
///////////////////////////////////////////////////////////
void emu::pc::Configurator::CFEBStatus(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
  ...
  pageHeader( in, out, AppNavigator()
	      ...
	      .addLink( "Crate Configuration", 
			"/" + getApplicationDescriptor()->getURN() + "/CrateConfiguration"  )
	      .addLink( "DMB Status", 
			"/" + getApplicationDescriptor()->getURN() + "/DMBStatus"  )
	      .addLink( Name )
	      );
  //
...
void emu::pc::Configurator::CFEBUtils(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  ...
  pageHeader( in, out, AppNavigator()
	      ...
	      .addLink( "Crate Configuration", 
			"/" + getApplicationDescriptor()->getURN() + "/CrateConfiguration"  )
	      .addLink( "DMB Utils", 
			"/" + getApplicationDescriptor()->getURN() + "/DMBUtils"  )
	      .addLink( Name )
	      );
...
void emu::pc::Configurator::CFEBFunction(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
...
void emu::pc::Configurator::DCFEBReadFirmware(xgi::Input * in, xgi::Output * out )
  throw (xgi::exception::Exception)
{
  ...
  DAQMB * thisDMB = dmbVector[dmb];
    ...
    std::string mcsfile="/tmp/DCFEB_"+chambername+"_C"+cfeb_value+".mcs";
     ...
     std::cout << emu::utils::getDateTime() << " DCFEB firmware read back from DMB " << dmb << " CFEB " << cfebs[icfeb].number()+1 << std::endl;

     thisDMB->dcfeb_readfirmware_mcs(cfebs[icfeb], mcsfile.c_str());
     
     std::cout << emu::utils::getDateTime() << " DCFEB firmware read back finished." << std::endl;
     this->CFEBUtils(in,out);           
                    
}
  

void emu::pc::Configurator::DCFEBProgramFpga(xgi::Input * in, xgi::Output * out )
  throw (xgi::exception::Exception)
{
  ...
  DAQMB * thisDMB = dmbVector[dmb];
     ...
     std::cout << emu::utils::getDateTime() << " DCFEB program FPGA on DMB " << dmb << " CFEB " << cfebs[icfeb].number()+1 << std::endl;
     std::cout << "Use mcs file: " << mcsfile << std::endl;

     thisDMB->dcfeb_program_virtex6(cfebs[icfeb], mcsfile.c_str());
     
     std::cout << emu::utils::getDateTime() << " DCFEB program FPGA finished." << std::endl;
     this->CFEBUtils(in,out);                    
}
  
void emu::pc::Configurator::DCFEBProgramEprom(xgi::Input * in, xgi::Output * out )
  throw (xgi::exception::Exception)
{
  ...
  DAQMB * thisDMB = dmbVector[dmb];
     ...
     std::cout << emu::utils::getDateTime() << " DCFEB program EPROM on DMB " << dmb << " CFEB " << cfebs[icfeb].number()+1 << std::endl;
     std::cout << "Use mcs file: " << mcsfile << std::endl;

     thisDMB->dcfeb_program_eprom(cfebs[icfeb], mcsfile.c_str());
     
     std::cout << emu::utils::getDateTime() << " DCFEB program EPROM finished." << std::endl;
     this->CFEBUtils(in,out);                    
}
  
void emu::pc::Configurator::DCFEBProgramEpromAll(xgi::Input * in, xgi::Output * out )
  throw (xgi::exception::Exception)
{
...
void emu::pc::Configurator::LVMBStatus(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
void emu::pc::Configurator::DMBUtils(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::CFEBTurnOn(xgi::Input * in, xgi::Output * out )
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBTurnOff(xgi::Input * in, xgi::Output * out )
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBLoadFirmware(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBVmeLoadFirmware(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBVmeLoadFirmwareEmergency(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::CFEBReadFirmware(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
...
//
void emu::pc::Configurator::CFEBLoadFirmware(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
...
//
void emu::pc::Configurator::CCBHardResetFromDMBPage(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  thisCCB->hardReset();
  //
...
//
void emu::pc::Configurator::CFEBLoadFirmwareID(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
...
//
void emu::pc::Configurator::DMBTurnOn(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
void emu::pc::Configurator::DMBCheckConfiguration(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
void emu::pc::Configurator::DMBConfigure(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
  ...
  if(name != cgi.getElements().end()) {
    dmb = cgi["dmb"]->getIntegerValue();
    std::cout << emu::utils::getDateTime() << " DMBConfigure  DMB " << dmb << std::endl;
    DMB_ = dmb;
  }
  //
  DAQMB * thisDMB = dmbVector[dmb];
...
// DMB status
///////////////////////////////////////////////////////////////////////////////////
void emu::pc::Configurator::DMBStatus(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
  //
  cgicc::Cgicc cgi(in);
  //
...
//
  //
void emu::pc::Configurator::DMBPrintCounters(xgi::Input * in, xgi::Output * out ) 
  throw (xgi::exception::Exception) {
    //
    cgicc::Cgicc cgi(in);
    //
...
////////////////////////////////////////////////////////////////////////////////////
xoap::MessageReference emu::pc::Configurator::ReadAllVmePromUserid (xoap::MessageReference message) 
...
//
xoap::MessageReference emu::pc::Configurator::LoadAllVmePromUserid (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference emu::pc::Configurator::ReadAllCfebPromUserid (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
...
//
xoap::MessageReference emu::pc::Configurator::LoadAllCfebPromUserid (xoap::MessageReference message) 
  throw (xoap::exception::Exception) {
  //
