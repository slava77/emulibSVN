...
mudcsMrtn_fill_mrtn_database(emu_side);
...
//============================
mudcsMrtn_fill_mrtn_database(string emu_side){
...
if(emu_side=="_DEV"){
dynAppend(db,"DEV_CR1;10");dynAppend(db_geog,"DEV Bld");//1
...
dynAppend(db,"M4_CR2;38");dynAppend(db_geog,"X2V52");//38
...
dynAppend(db,"M2_CR5;34");dynAppend(db_geog,"X2S41_L");//34
dynAppend(db,"M2_CR6;33");dynAppend(db_geog,"X2S41_U");//33
dynAppend(db,"M2_CR7;35");dynAppend(db_geog,"X2V42_L");//35
dynAppend(db,"M2_CR8;36");dynAppend(db_geog,"X2V42_U");//36
...
dynAppend(db,"P1_CR4;3");dynAppend(db_geog,"X4A31_U");//3
...
dynAppend(db,"P2_CR5;14");dynAppend(db_geog,"X2A41_L");//14
dynAppend(db,"P2_CR6;13");dynAppend(db_geog,"X2A41_U");//13
dynAppend(db,"P2_CR7;15");dynAppend(db_geog,"X2J42_L");//15
dynAppend(db,"P2_CR8;16");dynAppend(db_geog,"X2J42_U");//16
...
dynAppend(db,"P4_CR2;18");dynAppend(db_geog,"X2J52");//18
dynAppend(db,"P4_CR3;19");dynAppend(db_geog,"X4A51");//
