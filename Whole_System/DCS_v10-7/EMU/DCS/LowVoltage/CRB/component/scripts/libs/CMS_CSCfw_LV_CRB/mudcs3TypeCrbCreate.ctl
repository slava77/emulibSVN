...
xxdepes[5] = makeDynString ("","off_channels");
xxdepes[6] = makeDynString ("","error_status"); // combination of wrong state: state not 5 or 133--> (1) and timeout--> (10)
xxdepes[7]=makeDynString ("","bit_0");
xxdepes[8]=makeDynString ("","bit_1");
xxdepes[9]=makeDynString ("","bit_2");
xxdepes[10]=makeDynString ("","bit_3");
...
xxdepei[8]=makeDynInt (0,DPEL_BOOL);
xxdepei[9]=makeDynInt (0,DPEL_BOOL);
xxdepei[10]=makeDynInt (0,DPEL_BOOL);
