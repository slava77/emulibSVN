...
#include "emu/dqm/calibration/TestData1D.h"
#include "emu/dqm/calibration/TestData2D.h"
...
public:
  ...
  void SetLimits(Double_t,Double_t,Double_t,Double_t,Double_t,Double_t); ///< Set performance range limits
