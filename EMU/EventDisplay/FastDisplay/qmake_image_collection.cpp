/****************************************************************************
** Image collection for project 'FastDisplay'.
**
...
**      images/searchfind
**
** Created: Tue Feb 28 22:19:04 2006
**      by: The User Interface Compiler ($Id: qmake_image_collection.cpp,v 1.1 2006/03/06 10:04:59 golao Exp $)
**
...
class MimeSourceFactory_FastDisplay : public QMimeSourceFactory
{
public:
    MimeSourceFactory_FastDisplay() {}
    ~MimeSourceFactory_FastDisplay() {}
...
void qInitImages_FastDisplay()
{
    if ( !factory ) {
	factory = new MimeSourceFactory_FastDisplay;
	QMimeSourceFactory::defaultFactory()->addFactory( factory );
    }
}

void qCleanupImages_FastDisplay()
{
    if ( factory ) {
...
class StaticInitImages_FastDisplay
{
public:
    StaticInitImages_FastDisplay() { qInitImages_FastDisplay(); }
#if defined(Q_OS_SCO) || defined(Q_OS_UNIXWARE)
    ~StaticInitImages_FastDisplay() { }
#else
    ~StaticInitImages_FastDisplay() { qCleanupImages_FastDisplay(); }
#endif
};

static StaticInitImages_FastDisplay staticImages;
