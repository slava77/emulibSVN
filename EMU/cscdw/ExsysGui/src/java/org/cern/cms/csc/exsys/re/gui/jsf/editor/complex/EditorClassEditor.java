...
import org.cern.cms.csc.exsys.re.gui.jsf.util.ClassFinder;
...
public class EditorClassEditor extends RestrictedEntityEditor {
    ...
    public EditorClassEditor(EntityBase entity, Editor parentEditor, EntityDaoLocal entityDao) throws InvalidEntityBeanPropertyException {
        super(entity, null, parentEditor, entityDao);
        if (entity != null) {
