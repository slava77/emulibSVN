...
/**
 * <p>Java class for componentLinkClass.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="componentLinkClass">
 ...
 * 
 */
@XmlType(name = "componentLinkClass")
@XmlEnum
public enum ComponentLinkClass {
    ...
    public static ComponentLinkClass fromValue(String v) {
        for (ComponentLinkClass c: ComponentLinkClass.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
