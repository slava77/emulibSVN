...
public class ComponentImporter {
    ...
    private static final String DEFAULT_FLUSH_INTERVAL = "25";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            setPropertiesToNulls(em, "select c from org.cern.cms.csc.dw.model.ontology.ComponentClass as c", "parent");
