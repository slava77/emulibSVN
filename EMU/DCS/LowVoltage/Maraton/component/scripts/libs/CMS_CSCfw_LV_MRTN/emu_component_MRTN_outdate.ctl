...
main() {
  ...
  mudcsMrtnPnlInit();
  string ProjectHome = "C:\\PVSS_PROJECT_36\\csc_mrtn";
  string LV_PROJECT = "CMS_CSCfw_LV_MRTN";
...
//mudcsLvDebug("CYGWIN INSTALLED IS NEEDED!");
  ...
  string dir = "CMS_CSCfw_LV"; // operation panel directory
  string dir_config = "CMS_CSCfw_LV_CONF"; // configuration panel directory
...
//return;
  ...
  system("cmd /c mkdir " + ProjectHome + "\\" + LV_PROJECT + "\\special_stuff");
...
//          " "+ProjectHome+"\\"+LV_PROJECT+"\\panels\\"+dir+"\\"+"emuDevCRB_2Operation.pnl");
    ...
    if (mode == 1) {
// system("cmd /c cp "+ProjectHome+"\\panels\\"+dir+"\\emuDevCRB_2Operation.pnl"+
...
//---forming package: EMU DCS components------------
  ...
  */
  ...
  if (mode) {
    system("cmd /c cp " + ProjectHome + "\\scripts\\libs\\CMS_CSCfw_LV/emu*.ctl " +
           ProjectHome + "\\" + LV_PROJECT + "\\scripts\\libs\\" + dir + "\\.");
    if (mode == 2)system("cmd /c cp " + ProjectHome + "\\scripts\\libs\\CMS_CSCfw_LV/mudcs*.ctl " +
                           ProjectHome + "\\" + LV_PROJECT + "\\scripts\\libs\\" + dir + "\\.");
  } else system("cmd /c cp " + ProjectHome + "\\scripts\\libs\\CMS_CSCfw_LV/emufw.ctl " +
                  ProjectHome + "\\" + LV_PROJECT + "\\scripts\\libs\\" + dir + "\\.");
...
//=========== CONFIG ===============================================================================================
  ...
  if (!mode)system("cmd /c cp " + ProjectHome + "\\config\\CMS_CSCfw_LV_short.config " +
                     ProjectHome + "\\" + LV_PROJECT + "\\config\\CMS_CSCfw_LV.config");
  else system("cmd /c cp " + ProjectHome + "\\config\\CMS_CSCfw_LV_long.config " +
                ProjectHome + "\\" + LV_PROJECT + "\\config\\CMS_CSCfw_LV.config");

  if (mode == 2) {
    system("cmd /c cp " + ProjectHome + "\\config/CMS_CSCfw_LV_*.config " +
           ProjectHome + "\\" + LV_PROJECT + "\\config/.");

    system("cmd /c cp " + ProjectHome + "\\config/*.postInstall " +
           ProjectHome + "\\" + LV_PROJECT + "\\config/.");
  }
...
//============= XML ================================================================================================
  if (mode == 2) {
    system("cmd /c cp " + ProjectHome + "\\config\\CMS_CSCfw_LV_MRTN_long.xml " + ProjectHome + "\\" + LV_PROJECT + "\\CMS_CSCfw_LV_MRTN.xml");
  } else system("cmd /c cp " + ProjectHome + "\\config\\CMS_CSCfw_LV_MRTN_short.xml " + ProjectHome + "\\" + LV_PROJECT + "\\CMS_CSCfw_LV_MRTN.xml");

  if (mode == 2) {
    system("cmd /c cp " + ProjectHome + "\\config/*.xml " + ProjectHome + "\\" + LV_PROJECT + "\\config/.");
  }

//====  special stuff ======================================================================================
  system("cmd /c cp " + ProjectHome + "\\special_stuff/* " + ProjectHome + "\\" + LV_PROJECT + "\\special_stuff/.");
//===================================================================================================================
...
//dynAppend(all_dps,"fwOT_CRB_2");
//dps=dpNames("fwOT_CRB_2.*");
//dynAppend(all_dps,dps);
...
//string command="PVSS00ascii -out dplist\\migr_to_new_project.dpl ";
  string command = "cmd /c PVSS00ascii -out " + ProjectHome + "\\" + LV_PROJECT + "\\dplist\\" + dir + "\\CMS_CSCfw_LV.dpl -filterDpType _FwFsmObjectType ";
