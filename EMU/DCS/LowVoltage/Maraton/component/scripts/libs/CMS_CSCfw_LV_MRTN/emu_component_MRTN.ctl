...
string dir="CMS_CSCfw_LV_MRTN"; // operation panel directory 
string dir_config="CMS_CSCfw_LV_MRTN\\config"; // configuration panel directory
...
//MRTN/CRB specific  
 ...
 system("cmd /c cp "+ProjectHome+"\\panels\\"+dir+"\\emufwUi_short.pnl"+
  ...
  if(mode==1){   
// system("cmd /c cp "+ProjectHome+"\\panels\\"+dir+"\\emuDevfwMrtn_CSC_LVOperation.pnl"+
...
if(mode){
  system("cmd /c cp "+ProjectHome+"\\scripts\\libs\\CMS_CSCfw_LV_MRTN/emu*.ctl "+
                          ProjectHome+"\\"+LV_PROJECT+"\\scripts\\libs\\"+dir+"\\.");
  if(mode==2)system("cmd /c cp "+ProjectHome+"\\scripts\\libs\\CMS_CSCfw_LV_MRTN/mudcs*.ctl "+
                          ProjectHome+"\\"+LV_PROJECT+"\\scripts\\libs\\"+dir+"\\.");
}
else system("cmd /c cp "+ProjectHome+"\\scripts\\libs\\CMS_CSCfw_LV_MRTN/emufw.ctl "+
                          ProjectHome+"\\"+LV_PROJECT+"\\scripts\\libs\\"+dir+"\\.");
...
if(!mode)system("cmd /c cp "+ProjectHome+"\\source\\"+dir+"\\config\\CMS_CSCfw_LV_MRTN_short.config "+
                ProjectHome+"\\"+LV_PROJECT+"\\config\\CMS_CSCfw_LV_MRTN.config");
else system("cmd /c cp "+ProjectHome+"\\source\\"+dir+"\\config\\CMS_CSCfw_LV_MRTN_long.config "+
                ProjectHome+"\\"+LV_PROJECT+"\\config\\CMS_CSCfw_LV_MRTN.config");

if(mode==2){
  system("cmd /c cp "+ProjectHome+"\\source\\"+dir+"\\config/CMS_CSCfw_LV_MRTN*.config "+
                ProjectHome+"\\"+LV_PROJECT+"\\source\\"+dir+"\\config/.");  

//  system("cmd /c cp "+ProjectHome+"\\scripts\\"+dir+"/*.postInstall "+
//                ProjectHome+"\\"+LV_PROJECT+"\\scripts\\"+dir+"/CMS_CSCfw_LV_MRTN.postInstall"); 
...
//============= XML ================================================================================================
if(mode==2){
system("cmd /c cp "+ProjectHome+"\\source\\"+dir+"\\config\\CMS_CSCfw_LV_MRTN_long.xml "+ProjectHome+"\\"+LV_PROJECT+"\\CMS_CSCfw_LV_MRTN.xml");
}
else system("cmd /c cp "+ProjectHome+"\\source\\"+dir+"\\config\\CMS_CSCfw_LV_MRTN_short.xml "+ProjectHome+"\\"+LV_PROJECT+"\\CMS_CSCfw_LV_MRTN.xml");
...
string command="cmd /c PVSS00ascii -out "+ProjectHome+"\\"+LV_PROJECT+"\\dplist\\"+dir+"\\CMS_CSCfw_LV_MRTN.dpl -filterDpType _FwFsmObjectType ";
