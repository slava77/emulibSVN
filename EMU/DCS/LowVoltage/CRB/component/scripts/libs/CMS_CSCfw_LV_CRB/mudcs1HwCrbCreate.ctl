...
if(CSC_fwCAN1_g_904_MACHINE && !CSC_fwCAN1_g_P5_SIM){
dsCanBusDef=makeDynString("LVCB_1","LVCB_4","LVCB_2","LVCB_3");  
ddsElmbIDs[1]=makeDynInt(4,5,6,7,8,9,13,14,15,16,20,21,22,26,27,28); // decimal IDs as they will be transfered to HEX below
ddsElmbIDs[2]=makeDynInt(1,2,3,10,11,12,17,18,19,23,24,25,29,30);
ddsElmbIDs[3]=makeDynInt(31,32,33,40,41,42,43,47,48,49,53,54,55,59,60);
ddsElmbIDs[4]=makeDynInt(34,35,36,37,38,39,44,45,46,50,51,52,56,57,58);    
}

if(CSC_fwCAN1_g_DEV_MODE){// corr++
 dsCanBusDef=makeDynString("LVCB_1");
 ddsElmbIDs[1]=makeDynInt(1,2); // decimal IDs as they will be transfered to HEX below  
}
