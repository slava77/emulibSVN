...
dynAppend(device_types,"fwWnrCh_CSC_LV_d");
dynAppend(device_types,"HV_1_d");
dynAppend(device_types,"LV_1_d");
dynAppend(device_types,"TEMP_1_d");
...
//-----------------------------------------------------------------------------
else if(device_type == "fwWnrCr_CSC_LV_d"){
...
*/
//-----------------------------------------------------------------------------
else if(device_type == "fwWnrCh_CSC_LV_d"){
