...
addGlobal("CSC_fwG_g_MRTN_SYSTEM_NAME",STRING_VAR);
...
//--------------------------------------------------------------------------
   ...
   if(dynlen(systemNamesDps)==0)DebugTN("MRTN SYSTEM NAME NOT DEFINED !");
   else{
    s_split=strsplit(systemNamesDps[1],":"); 
    CSC_fwG_g_MRTN_SYSTEM_NAME=s_split[1];//dpSubStr(systemNamesDps[1], DPSUB_SYS);
   }
...
addGlobal("CSC_fwG_g_MRTN_DOMAIN",STRING_VAR);
CSC_fwG_g_MRTN_DOMAIN="CMS_CSC_LV_CAN2";
//--------------------------
...
CSC_fwG_g_Dubna_System_Name="dist_254";
...
g_HV_ID2PC_NAME=makeDynString("500_part1;10.176.11.67_part1","500_part2;10.176.11.67_part2",
                              "500_part3;10.176.11.67_part3","500_part4;10.176.11.67_part4"); // ufcmshv2  
}
...
CSC_fwG_g_PCRATE_ID2PC_NAME=makeDynString("all;dcspcS2G19-06");
...
CSC_fwG_g_BROKER_DNS_MACHINE_NAMES=makeDynString
    ...
    "HV_PR;10.176.11.103_part4", // ufcmshv2: for primary commands only
    "HV_PR;10.176.11.67_part4", // ufcmshv2: for primary commands only    
    "HV_1;10.176.11.103_part4",   // ufcmshv2: for primary commands only
    "HV_1;10.176.11.67_part4"   // ufcmshv1: for primary commands only   
//    "HV_PR;ufcmspc02",
//    "HV_1;ufcmspc02"
