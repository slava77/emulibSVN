    ...
    implements Serializable
{
     ...
     *     
     */
    public void setStateChangeTime(Date value) {
     ...
     */
    @Basic
    @Column(name = "FCT_DQM_EVENTS", precision = 20, scale = 0)
     ...
     */
    @Basic
    @Column(name = "FCT_DQM_RATE", precision = 20, scale = 0)
     ...
     */
    @Basic
    @Column(name = "FCT_CSC_RATE", precision = 20, scale = 0)
     ...
     */
    @Basic
    @Column(name = "FCT_CSC_DETECTED", precision = 20, scale = 0)
     ...
     */
    @Basic
    @Column(name = "FCT_CSC_UNPACKED", precision = 20, scale = 0)
