    ...
    implements Serializable
{
     ...
     */
    @Basic
    @Column(name = "FCT_INPUT_IN_ERROR_STATE", precision = 20, scale = 0)
     ...
     */
    @Basic
    @Column(name = "FCT_INPUT_IN_WARN_STATE", precision = 20, scale = 0)
     ...
     */
    @Basic
    @Column(name = "FCT_NO_INPUT_DATA", precision = 20, scale = 0)
