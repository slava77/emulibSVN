...
public class DimServiceProvider implements DimServiceProviderRemote {
    ...
    private static final Logger logger = SimpleLogger.getLogger(DimServiceProvider.class);
...
//        try {
//            dimPubActions = entityDao.ejb().getAllEntitiesByClass(DimPublicationAction.class);
//        } catch (InvalidEntityClassException iecEx) {
//            throw new RuntimeException("Program Error", iecEx);
//        }
//
...
//    @Override
//    public void publishString(DimPublicationAction dimPubAction, String value) {
//        getService(dimPubAction).updateService(value);
//    }
//
//    private DimService getService(DimPublicationAction dimPubAction) {
...
//        }
//
//        throw new RuntimeException("Unsupported DIM service data type: " + dataType);
//    }
